...
// ***********      Registro de usuarios con herramientas de Firebase


    private fun createAccount(email: String, password:String){
        Toast.makeText(baseContext, "OnCreateFunction:"+email.toString()+password.toString(),
...
// ***********       Registro de usuario manual con firebase *************
